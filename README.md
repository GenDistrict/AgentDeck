...
Current stable release: **0.1.201** (Windows; macOS 0.1.201 is rolling out — 0.1.199 links below stay valid until promotion)

| Platform | Download | Requirements |
| --- | --- | --- |
| Windows | [AgentDeck Setup 0.1.201.exe](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.201/windows/x64/AgentDeck%20Setup%200.1.201.exe) | Windows 10/11, x64 |
| macOS | [AgentDeck-0.1.199-arm64.dmg](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.199/macos/arm64/AgentDeck-0.1.199-arm64.dmg) | macOS 13+, Apple Silicon |
