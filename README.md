...
Current stable release: **0.1.207**

| Platform | Download | Requirements |
| --- | --- | --- |
| Windows | [AgentDeck Setup 0.1.207.exe](https://storage.googleapis.com/gendistrict-agentdeck-updates/releases/0.1.207/windows/x64/AgentDeck%20Setup%200.1.207.exe) | Windows 10/11, x64 |
